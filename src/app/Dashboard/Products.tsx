export const data = [
  ...
  //   icon: 'swaggerIcon',
  //   costPerHour: '11.24 créditos'
  // },
  {
    id: 9,
    name: 'SEI',
    description: 'SEI Municípios',
    icon: '',
    costPerHour: '11.24 créditos'
  }
];
